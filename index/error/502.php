...
<div style="height: 100%;width: 100%;">
    ...
    <div class="text_p">
        <h1>YOU SEEM TO HAVE SENT TOO MANT REQUESTS</h1>
        <h1 style='color:rgb(255, 191, 255);margin-top: -40px;' id="h1_v">ERROR 502</h1>
        <h1 style='color:white;margin-top: -90px;color: rgb(222, 255, 184);' id="h1_c">WAIT A MINUTE</h1>
    </div>
    <div>
